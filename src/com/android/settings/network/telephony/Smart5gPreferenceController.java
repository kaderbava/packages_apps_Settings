...
public class Smart5gPreferenceController extends TelephonyTogglePreferenceController
    ...
    private boolean mShowSmart5G = false;
    ...
    public Smart5gPreferenceController(Context context, String key) {
        ...
        // Check if config_ShowSmart5G exists and is true
        try {
            Resources res = context.getResources();
            int resId = res.getIdentifier("config_ShowSmart5G", "bool", context.getPackageName());
            if (resId != 0) {
                mShowSmart5G = res.getBoolean(resId);
            }
        } catch (Resources.NotFoundException e) {
            Log.e(TAG, "config_ShowSmart5G resource not found", e);
        }

        Log.d(TAG, "mShowSmart5G: " + mShowSmart5G);
    }
    ...
    public int getAvailabilityStatus(int subId) {
        init(subId);
        return (mHas5gCapability && mShowSmart5G) ? AVAILABLE : CONDITIONALLY_UNAVAILABLE;
    }
