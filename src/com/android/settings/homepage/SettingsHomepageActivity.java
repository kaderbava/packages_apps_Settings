...
public class SettingsHomepageActivity extends FragmentActivity implements
    ...
    initDashboardMessages();
        ...
        if (!getSystemService(ActivityManager.class).isLowRamDevice()) {
            ...
            if (getResources().getBoolean(R.bool.config_show_homepage_suggestions)) {
                showSuggestionFragment(scrollNeeded);
            } else {
                // Ensure homepage is visible if we skipped suggestions
                View homepage = findViewById(R.id.settings_homepage_container);
                if (homepage != null) homepage.setVisibility(View.VISIBLE);
                View suggestion = findViewById(R.id.suggestion_content);
                if (suggestion != null) suggestion.setVisibility(View.GONE);
            }
            if (getResources().getBoolean(R.bool.config_show_contextual_home_cards)
                ...
                // Hide contextual cards container when disabled
                View contextual = findViewById(R.id.contextual_cards_content);
                if (contextual != null) contextual.setVisibility(View.GONE);
            }
        }
...
private void initDashboardMessages() {
    ...
    final TextView searchTextView = root.findViewById(R.id.search_bar_title);
